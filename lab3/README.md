...
Runs a timed sequence of two circles. Slower speeds and a time multiplier (e.g., 1.35) are used to compensate for Gazebo's Real-Time Factor (RTF) physics delays and motor limits:
